...
namespace ComposableDelegatesRef
{

    public delegate void MyComposableDelegate(int args1, ref int args2);

    class ComposableDelegatesRef
    {
        static void func1(int args1, ref int args2)
        {
        ...
        static void func2(int args1 , ref int args2)
        {
            string result = (args1 * args2).ToString();
